...
import com.callor.myword.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        객체를 초기화 할때 2개의 새로운 객체를 주입하면서 객체를 초기화 해야 한다
        */
...
//            startActivity(wordIntent);
            ...
            새로 열린 Act. 에서 단어를 입력하고 저장버튼을 클릭하면 입력된 단어를
            다시 MainAct. 로 되돌려 주기 위한 Activity Open
             */
