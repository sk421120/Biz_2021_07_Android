...
public class MainActivity extends AppCompatActivity {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        // SearchView 클래스가 지정된 item을 가져와서 searchView 객체로 생성하기
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextSubmit(String s) {
                ...
                if (!s.isEmpty()){
                    /*
                    actionFr..To..SecondFr() method에 값 주입하여 SecondFragment로 값 전달하기
                    nav_graph.xml에 설정된 argument 변수에 값을 세팅하는 것으로 'defaultValue'
                    값을 없애고 매개변수로 값을 주입하여 전달한다
                     */
                    ...
                    // 만약 firstfragment 화면이 아닌경우 second
